...
只不过，它是一个主打随机漫游的电台。每一次点击，都会让你随机降落到世界的某个角落，3D 地球也会同步转动，将目的地置于视野中心，让你能直观感知到声音的位置。

可能，上一刻还在中东聆听阿拉伯式的吟唱，下一刻就来到了非洲腹地，热闹奔放，又或者刚穿越到东南亚接受热带气息的洗礼，转眼间，耳边又响起了激情昂扬的朝鲜电台。

这大概就是我心目中，漫游世界最具体的模样。
...
有一段时间，我特别沉迷折腾家里的 Nas，搭建各种效率工具，比如之前分享的[让特斯拉行程无缝接入日历](/posts/tesla-calendar-integration)。

后来，为了替代滴答清单的专注计时，我又自己在 Docker 里「造」了一个轮子。为了不单调，我给它设计了两种背景音：一种是常规的白噪音，如雨声、咖啡馆噪音；另一种则是**随机电台，**这也是 Roam FM 最早的雏形。我挑选了大约 100 个非中文电台，每次点击随机播放，只显示名字和国家。

结果没想到，这个「副产品」竟然比专注计时更深得我心。

于是，我让它在 Nas 里继续「内测」了一两个月。期间，我不断打磨那些看似简单的随机规则，并扩充了更多电台。看着它逐渐从一个简陋的脚本变得有血有肉，直到我决定把它从 Nas 里真正孵化出来。
...
至于文案和多语言，基本是我提供骨架，AI 填充血肉。Roam FM 目前支持简中、繁中、英、日、德五种语言，专门加了德语，是因为后台数据显示德国付费用户意外是最多的。
...
原本以为，这一次至少验证了技术实现上没有过不去的阻碍，会比上一个死在 Demo 阶段的产品要好，但没想到卡在了提审这最后一步。先是被复杂的后台绕晕了，后来是直接被拒审，直到现在还是。
